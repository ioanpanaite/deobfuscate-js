...
(function() {
    ...
    function WZW(m) {
        ...
        for (var l = 0; l < s; l++) {
            var v = q * (l + 484) + (q % 22839);
            var d = q * (l + 317) + (q % 29571);
            var n = v % s;
            var c = d % s;
            var j = t[n];
            t[n] = t[c];
